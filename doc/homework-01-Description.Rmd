...
## I. feladat (2 pont)
1. Nyiss egy új R fájlt a ```homework-01``` R projekten belül egy ```src``` nevű mappában, majd nevezd el a fájlt ```homework-01.R```-nek!
...
2. A ```homework-01.R``` fájl írása közben minimum kétszer commitolj:
...
3. A ```.gitignore``` fájlból vedd ki az ```src/homework-01.R``` sort, és commitold!
